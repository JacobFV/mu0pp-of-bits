class MuZeroConfig:
    def __init__(self):
        ...
        self.replay_buffer_size = 10000  # |D| ∈ ℕ
        ...
        self.gradient_clip = 0.5  # θ_{clip} ∈ ℝ^+
        ...
        self.checkpoint_interval = 100  # Save model every 100 iterations.
